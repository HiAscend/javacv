...
public class LabelImageTest {
    ...
    public static void main(String[] args) {
        ...
        String modelDir = "Z:\\adeng\\work\\tftest\\test\\pb";
        String imageFile = "Z:\\adeng\\work\\tftest\\test\\img\\test3.jpg";
        ...
        try (Tensor<Float> image = constructAndExecuteGraphToNormalizeImage(imageBytes)) {
            ...
            System.out.println("Arrays.toString(labelProbabilities) = " + Arrays.toString(labelProbabilities));
